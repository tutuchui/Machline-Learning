...
bestC_rbf = ClassificationInnerCrossVal(X,Y,'polynomial','BoxConstraint');
bestPoly = ClassificationInnerCrossVal(X,Y,'polynomial','PolynomialOrder');
polyModel = fitcsvm(X,Y,'KernelFunction','polynomial','BoxConstraint',bestC_rbf,'PolynomialOrder',bestPoly);
